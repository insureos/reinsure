...
const LiquidityPositionPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <NextSeo title="Liquidity Position" description="ReInsure" />
      <div className="mx-auto w-full max-w-lg text-sm">
        <h3 className="mb-4 text-lg font-medium text-white sm:mb-6 sm:text-2xl">
        ...
        <Alert>
          ...
          <p className="m-0 text-sm leading-relaxed tracking-tighter text-gray-400">
        ...
        <div className="mt-6 rounded-lg bg-light-dark p-4 shadow-card sm:p-6">
          <div className="rounded-lg border border-solid border-gray-700 bg-dark">
            <div
            ...
            >
              ...
              <span className="flex items-center text-sm text-gray-300">
                Manage
                <ChevronDown
                  className={`ml-1.5 transition-all ${
            ...
            <AnimatePresence initial={false}>
              {isExpand && (
                ...
                >
                  <div className="border-t border-dashed border-gray-700 p-4 sm:p-6">
                    ...
                    <Button
                      ...
                      fullWidth={true}
                      color="gray"
                      className="mt-6 bg-gray-800 uppercase"
                    >
                      Remove
                    </Button>
                  </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4">
            ...
            <Button
              ...
              fullWidth={true}
              color="gray"
              className="bg-gray-800 uppercase"
            >
              Import
            </Button>
          </div>
