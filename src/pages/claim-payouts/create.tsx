    ...
    <div className="">
      <div className="group mb-4 rounded-md bg-dark/60 p-5 pt-3 xs:p-6 xs:pb-8">
        <div className="-mr-2 mb-3 flex items-center justify-between">
          <h3 className="font-medium text-gray-100">Action #1</h3>
          <Button
            type="button"
            size="mini"
            shape="circle"
...
const CreateProposalPage: NextPageWithLayout = () => {
  ...
  function goToAllProposalPage() {
    setTimeout(() => {
      router.push(routes.claimPayouts);
    }, 800);
  }
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-[1160px] text-sm">
        ...
        <div className="mb-6 rounded-lg bg-light-dark p-5 shadow-card transition-shadow duration-200 hover:shadow-large xs:p-6 xs:pb-8">
          <h3 className="mb-2 font-medium text-gray-100 xl:text-lg">Claim Conditions</h3>
        ...
        <div className="mb-6 rounded-lg bg-light-dark p-5 shadow-card transition-shadow duration-200 hover:shadow-large xs:p-6 xs:pb-8">
          <h3 className="mb-2 font-medium text-gray-100 xl:text-lg">Claim Amount</h3>
          <p className="mb-5 leading-[1.8] text-gray-300">
            Your title introduces your proposal to the voters. Make sure it is
            clear and to the point.
          </p>
          <Input type='number' placeholder="Enter Claim Amount (In USD)" />
        </div>
        <div className="mb-6 rounded-lg bg-light-dark p-5 shadow-card transition-shadow duration-200 hover:shadow-large xs:p-6 xs:pb-8">
          <h3 className="mb-2 font-medium text-gray-100 xl:text-lg">
            Description
          </h3>
          <p className="mb-5 leading-[1.8] text-gray-300">
