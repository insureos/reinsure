  ...
  return (
    <>
      <NextSeo
        ...
        description="InsureOS"
      />

      <div className="flex max-w-full flex-col items-center justify-center text-center">
        <div className="relative w-52 max-w-full sm:w-[400px] xl:w-[450px] 3xl:w-[500px]">
          {isMounted && <Image src={ErrorDarkImage} alt="404 Error" />}
        </div>

        <h2 className="mt-5 mb-2 text-base font-medium uppercase tracking-wide text-white sm:mt-10 sm:mb-4 sm:text-xl 3xl:mt-12 3xl:text-2xl">
