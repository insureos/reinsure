...
const VotePage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <NextSeo title="Vote" description="ReInsure" />
      <div className="mx-auto w-full max-w-[1160px] text-sm md:pt-14 4xl:pt-24">
        ...
        >
          <motion.div
            ...
            className={cn(
              'flex cursor-pointer flex-col items-center justify-center rounded-lg bg-light-dark p-6 text-center shadow-card transition-shadow duration-200 hover:shadow-large',
          ...
          >
            ...
            <h3 className="mb-2 mt-6 text-sm font-medium uppercase text-gray-100 sm:text-base 3xl:text-lg">
              Vote with Pool
            </h3>
          ...
          <motion.a
            ...
            className={cn(
              'rounded-lg bg-light-dark p-6 shadow-card transition-shadow duration-200 hover:shadow-large'
            )}
          >
          ...
          <motion.div
            ...
            onClick={() => router.push('/')}
            className={cn(
              'cursor-pointer rounded-lg bg-light-dark p-6 shadow-card transition-shadow duration-200 hover:shadow-large'
            )}
          >
