            ...
            <div className="block w-1/2 shrink-0 md:w-2/5">
              <h3 className="mb-1 truncate text-13px font-medium uppercase tracking-wider text-white sm:mb-1.5 sm:text-sm">
                ...
                <AnchorLink
                  ...
                  className="normal-case text-gray-400 hover:text-white md:hidden"
                >
                  @{currentBid?.name}
                </AnchorLink>
              </h3>
              ...
              <AnchorLink
                href={`${currentBid?.authorSlug}` ?? '#'}
                className="mt-2 hidden items-center text-sm font-medium text-gray-400 hover:text-white md:inline-flex"
              >
                <div className="mr-2 h-6 w-6 rounded-full">
