...
export default function AmountPerInvestment() {
  ...
  return (
    <div className="text-sm font-normal">
      <p className="mb-2 text-white sm:mb-3">
        Amount Per Investment
      </p>
      <div className="mb-2 flex items-center justify-between text-gray-400 sm:mb-3">
      ...
      <div className="relative">
        <Input
          ...
          inputClassName="border-[#E2E8F0] !bg-light-dark reset-password-pin-code appearance-none rounded-lg placeholder:!text-gray-500 !text-sm !font-medium pr-16 pl-4"
        />
