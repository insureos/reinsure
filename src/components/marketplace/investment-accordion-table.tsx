      ...
      <div className="w-full transform transition duration-300 ease-in">
        <Scrollbar style={{ width: '100%' }} autoHide="never">
          <div className="relative z-10">
            ...
            >
              <thead className="block text-sm bg-light-dark text-gray-300">
              ...
              <tbody
                {...getTableBodyProps()}
                className="grid text-xs font-medium bg-light-dark text-white 3xl:text-sm"
              >
                {page.map((row, idx) => {
                  prepareRow(row);
                  return (
                    <tr
                      {...row.getRowProps()}
                      key={idx + 1}
                      className="items-center rounded py-3 uppercase transition-all last:mb-0 bg-light-dark hover:bg-gray-700 xl:py-4"
        ...
        <div
          className={`-mt-[2px] flex items-center justify-center rounded-bl-lg rounded-br-lg px-4 py-4 text-sm shadow-card bg-light-dark lg:py-6`}
        >
