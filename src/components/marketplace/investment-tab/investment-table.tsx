...
import InvestmentAccordionTable from '@/components/marketplace/investment-accordion-table';
    ...
    Cell: ({ row }) => (
      <div className="flex items-center gap-3">
        ...
        <span className="inline-block">
          <p className="text-start text-sm font-medium uppercase text-white">
            {row.original.name}
          </p>
      ...
      return (
        <div className="w-full">
          {value && (
            ...
            >
              <MoreIcon className="w-6 text-white" />
            </button>
          )}
        </div>
      );
