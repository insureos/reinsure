...
export default function TotalProfit() {
  ...
  return (
    <>
      <div className="h-full w-full flex-grow rounded-lg border p-5 pb-4 pt-4 border-[#222A35] bg-[#222A35] lg:p-8">
          ...
          <div className="h-96 w-full pt-3">
            ...
            >
              <ComposedChart
                ...
                barSize={14}
                className="[&_.recharts-bar-rectangles]:fill-[#334155] [&_.recharts-cartesian-axis-tick-value]:fill-gray-500"
              >
                <defs>
                  <linearGradient
