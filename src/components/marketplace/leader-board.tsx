...
export default function LeaderBoard() {
  return (
    <Tab.Group key="nested">
      <Tab.List className="relative mx-auto flex h-13 max-w-[376px] justify-between rounded-full px-1.5 text-sm bg-[#0C0F19] shadow-2xl min-[375px]:justify-start min-[375px]:gap-6 2xl:gap-10">
        <TabItem
