...
const LeaderBoard = dynamic(
  () => import('@/components/marketplace/leader-board'),
  {
    loading: () => <LoaderComponent />,
  }
);
const HotCoinList = dynamic(
  () => import('@/components/marketplace/hot-coin-list'),
  {
    loading: () => <LoaderComponent />,
  }
);
const NewCoinList = dynamic(
  () => import('@/components/marketplace/new-coin-list'),
  {
    loading: () => <LoaderComponent />,
  }
);
      ...
      <Tab.Group key={'list-tabs'}>
        <div className="flex items-start">
          ...
          <div className="-mb-4 flex h-full min-h-[36px] w-full items-start overflow-hidden xs:mb-0">
            <Tab.List
              ref={sliderEl}
              className="coin-list-scrollbar relative flex w-full justify-between overflow-x-auto scroll-smooth border-b border-gray-800 text-sm min-[375px]:justify-start min-[375px]:gap-6 xs:mb-0 2xl:gap-10"
            >
