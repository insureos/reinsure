    ...
    <AnimateSharedLayout>
      <motion.div layout initial={{ borderRadius: 16 }} className="rounded-2xl">
        {totalVote > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-lg bg-light-dark px-4 py-16 text-center shadow-card xs:px-6 md:px-5 md:py-24">
            ...
            <h2 className="mb-3 font-medium leading-relaxed text-gray-100 md:text-lg xl:text-xl">
            ...
            <p className="leading-relaxed text-gray-400">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 text-gray-100 underline transition-opacity duration-200 hover:no-underline hover:opacity-90"
              >
